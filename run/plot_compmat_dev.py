...
print(f"num cellular vars = {v_c}")
print(f"num lumenal vars = {v_l}")
print(f"num cells = {n_c}")
print(f"num lumen discs = {n_l}")
...
results = h5py.File('matlab_final.h5', 'r')
matfinal = np.asarray(results['/x'])[-1, :]
