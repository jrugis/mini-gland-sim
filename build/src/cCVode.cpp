...
void cCVode::init(CVRhsFn rhs_func, Array1Nd& yini, void* user_data)
{
  int retval;
  nvars = yini.cols();
  realtype t0 = 0.0;
  ...
  retval = CVodeInit(cvode_mem, rhs_func, t0, y);
...
void cCVode::run(realtype t, realtype tout, Array1Nd& yout)
{
  int retval;
